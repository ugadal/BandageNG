...
test_all "$bandagepath --distance" 114 "" "--distance: 1 required INT missing Run with --help or --helpall for more information."
test_all "$bandagepath --distance abc" 104 "" "Could not convert: --distance = abc Run with --help or --helpall for more information."
test_all "$bandagepath --mindepth" 114 "" "--mindepth: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --mindepth abc" 104 "" "Could not convert: --mindepth = abc Run with --help or --helpall for more information."
test_all "$bandagepath --maxdepth" 114 "" "--maxdepth: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --nodelen"  114 "" "--nodelen: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --minnodlen" 114 "" "--minnodlen: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --edgelen" 114 "" "--edgelen: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --edgewidth" 114 "" "--edgewidth: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --doubsep" 114 "" "--doubsep: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --nodseglen" 114 "" "--nodseglen: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --iter" 114 "" "--iter: 1 required INT:INT in [0 - 4] missing Run with --help or --helpall for more information."
test_all "$bandagepath --nodewidth" 114 "" "--nodewidth: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --depwidth" 114 "" "--depwidth: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --deppower" 114 "" "--deppower: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --fontsize" 114 "" "--fontsize: 1 required missing Run with --help or --helpall for more information."
...
test_all "$bandagepath --outline" 114 "" "--outline: 1 required FLOAT missing Run with --help or --helpall for more information."
...
test_all "$bandagepath --toutline" 114 "" "--toutline: 1 required FLOAT missing Run with --help or --helpall for more information."
...
test_all "$bandagepath --ransatpos" 114 "" "--ransatpos: 1 required INT missing Run with --help or --helpall for more information."
test_all "$bandagepath --ransatneg" 114 "" "--ransatneg: 1 required INT missing Run with --help or --helpall for more information."
test_all "$bandagepath --ranligpos" 114 "" "--ranligpos: 1 required INT missing Run with --help or --helpall for more information."
test_all "$bandagepath --ranligneg" 114 "" "--ranligneg: 1 required INT missing Run with --help or --helpall for more information."
test_all "$bandagepath --ranopapos" 114 "" "--ranopapos: 1 required INT missing Run with --help or --helpall for more information."
test_all "$bandagepath --ranopaneg" 114 "" "--ranopaneg: 1 required INT missing Run with --help or --helpall for more information."
...
test_all "$bandagepath --depvallow" 114 "" "--depvallow: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --depvalhi" 114 "" "--depvalhi: 1 required FLOAT missing Run with --help or --helpall for more information."
...
test_all "$bandagepath --alfilter" 114 "" "--alfilter: 1 required INT missing Run with --help or --helpall for more information."
test_all "$bandagepath --qcfilter" 114 "" "--qcfilter: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --ifilter"  114 "" "--ifilter: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --evfilter" 114 "" "--evfilter: 1 required SCINOT missing Run with --help or --helpall for more information."
test_all "$bandagepath --evfilter abc" 104 "" "Could not convert: --evfilter = abc Run with --help or --helpall for more information."
# test_all "$bandagepath --evfilter 1" 0 "" ""
# test_all "$bandagepath --evfilter 1.0" 0 "" ""
test_all "$bandagepath --evfilter e1" 104 "" "Could not convert: --evfilter = e1 Run with --help or --helpall for more information."
test_all "$bandagepath --bsfilter"  114 "" "--bsfilter: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --pathnodes" 114 "" "--pathnodes: 1 required INT missing Run with --help or --helpall for more information."
test_all "$bandagepath --minpatcov" 114 "" "--minpatcov: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --minhitcov" 114 "" "--minhitcov: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --minmeanid" 114 "" "--minmeanid: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --minpatlen" 114 "" "--minpatlen: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --maxpatlen" 114 "" "--maxpatlen: 1 required FLOAT missing Run with --help or --helpall for more information."
test_all "$bandagepath --minlendis" 114 "" "--minlendis: 1 required INT missing Run with --help or --helpall for more information."
test_all "$bandagepath --maxlendis" 114 "" "--maxlendis: 1 required INT missing Run with --help or --helpall for more information."
test_all "$bandagepath --maxevprod" 114 "" "--maxevprod: 1 required SCINOT missing Run with --help or --helpall for more information."
